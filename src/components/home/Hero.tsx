    ...
    <section className="relative min-h-[90vh] flex items-center pt-40 lg:pt-52 pb-20 overflow-hidden bg-white">
      ...
      <div className="container-custom relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-black/40">
                1-Gang & 2-Gang specialized systems
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-9xl font-extrabold tracking-tighter text-black leading-[0.85] mb-10"
            >
              Hardware <br />
              <span className="text-black/30 italic font-light text-5xl md:text-7xl lg:text-8xl">Redefined.</span>
            </motion.h1>
            ...
            >
              The world&apos;s first wall plate with a customizable wallpaper inlay. Achieve perfect visual continuity in every room.
            </motion.p>
          ...
          >
            <div className="relative aspect-square rounded-[3rem] lg:rounded-[4rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] border border-black/5 group bg-[#F9F9FB]">
              <Image
                src="/assets/aura-1-gang-yellow.png"
                alt="Barrera Aura 1-Gang with Wallpaper Inlay"
                fill
              ...
              >
                <div className="flex items-center gap-4 text-black">
                   ...
                   <div>
                      <p className="text-[10px] font-bold uppercase tracking-[0.2em] mb-1">Aura Tech</p>
                      <p className="text-[10px] text-black/40 font-bold">1-Gang & 2-Gang.</p>
                   </div>
                </div>
              </motion.div>
            </div>
